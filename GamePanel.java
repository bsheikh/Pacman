...
public class GamePanel extends JPanel{
	...
	/** Tracks the time */
	private double firstTime; //Time
	
	/** The delay of the timer */
	final int DELAY = 30; //Delay
	
	/** The timer variable as t */
	public Timer t;
	
	/** The first start of the program */
	...
	/** The creatures ArrayList */
	public ArrayList<Creature> creatures;
	
	/** The slow prey creatures array. */
	public ArrayList<SlowPrey> slowPreyCreaturesArray;
	
	/** The fast prey creatures array. */
	...
	/** The slow prey creature. */
	public SlowPrey slowPreyCreature;
	
	/** The fast prey creature. */
	 ...
	 * 
	 * @param g, Graphic g to draw components
	 */
